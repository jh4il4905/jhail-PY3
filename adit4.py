...
aditmadzs = LineClient(authToken='Ezi57lvPqOUv2qLK4l34.mqKc2MNKlpicxDXNF/VJPa./OBdU15jEFXHGblJfXD5l9k57gB+fdIkHiHoV4m9e3A=')
...
ki = LineClient(authToken='EzQQCv1OJ0jcBzWlYjDc.dP9jwNnpN82C9ikgCsDSVa.bSKDeyMMj8FlvTSlgwe7aRnClVFfohmB4SP41iXbQ0U=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='EzgnGUYD3T6HBbfA6NW9.FcuMrOXqhOS3oyxH8r2Bsq.lkDOWe/ssKmHqk0XrtCIrNkzAcdtNg0FO4VI+ri7Vdw=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='Ezi57lvPqOUv2qLK4l34.mqKc2MNKlpicxDXNF/VJPa./OBdU15jEFXHGblJfXD5l9k57gB+fdIkHiHoV4m9e3A=')
...
call = aditmadzs
creator = ["u0e9f495a734f9fcd9cf4828671276cbc"]
owner = ["u0e9f495a734f9fcd9cf4828671276cbc"]
admin = ["u0e9f495a734f9fcd9cf4828671276cbc"]
staff = ["u0e9f495a734f9fcd9cf4828671276cbc"]
